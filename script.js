...
const translations = {
  'zh-CN': {
    ...
    'projects.lead': '这里不是陈列柜，而是一组持续生长的实验：从论文解析、视频理解、AI 图像工具到实体交互设备，每个项目都尽量留下代码、文档和可复现的使用路径。',
    'filters.all': '全部项目',
    'filters.perception': '感知与机器人',
    'filters.tool': '工具与自动化',
    'filters.experience': '数字体验',
    'project.tennis.description': '融合音频瞬态、人体姿态与球拍检测，自动理解网球视频中的击球与回合，并使用 GPU 加速导出。',
    'project.scholarAnalysis.description': '为重要论文建立长期维护的独立目录，把中文解析、原创图解、工程复现、公开材料与 GitHub Issue 讨论组织成可发布的研究阅读站。',
    'project.gptImage.description': '通过 OpenAI 兼容中转接口与 CC-Switch 使用 GPT-Image 模型，注重可靠调用与 API Key 安全。',
    'project.sparkBilingual.description': '把 PDF、文件夹或 arXiv 论文转换为连续的中英双语 HTML，让原文段落、对应译文与插图沿原始阅读顺序自然衔接。',
    ...
    'project.travel.description': '持续更新的双语旅行计划集合，目前收录东莞自由潜计划，并保留海南七天东线计划。',
    'links.homepage': '项目主页 ↗',
    'links.source': '源代码 ↗',
    'links.guide': '使用指南 ↗',
    'links.learn': '了解项目 ↗',
    ...
    'alt.scholarAnalysis': 'ScholarAnalysis 中文论文图解与工程复现分析网站首页',
    'alt.gptImage': 'GPT Image 2 CLI 项目网站首页',
    'alt.sparkBilingual': 'Spark Bilingual 双语论文阅读项目网站首页',
  ...
  en: {
    ...
    'projects.lead': 'This is not a display case. It is a growing set of experiments—from paper analysis and video understanding to AI image tools and physical interaction devices—with code, documentation, and reproducible paths wherever possible.',
    ...
    'project.scholarAnalysis.description': 'A long-lived publishing space for important papers, organizing Chinese explanations, original diagrams, engineering reproduction notes, rights-cleared public materials, and GitHub Issue discussions.',
    ...
    'project.sparkBilingual.description': 'Turns PDFs, folders, or arXiv papers into continuous bilingual HTML, keeping each source paragraph, translation, and figure in the original reading order.',
    ...
    'project.travel.description': 'A growing bilingual collection of travel plans, currently featuring the Dongguan freediving trip while preserving the seven-day Hainan east-coast plan.',
    ...
    'alt.scholarAnalysis': 'Homepage of ScholarAnalysis, a Chinese paper-visualization and engineering-reproduction website',
    'alt.gptImage': 'Homepage of the GPT Image 2 CLI project website',
    'alt.sparkBilingual': 'Homepage of the Spark Bilingual paper-reading project website',
